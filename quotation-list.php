<!DOCTYPE html><html lang="en">
    ...
    <body>
        ...
        <div class="main-wrapper">
			...
			<?php $page = 'quotation-list'; include './includes/sidebar.php'; ?>
												...
												<div class="row">
													...
													<div class="col-lg-2 col-sm-2 col-2 p-0">
														<div class="add-icon tab">
															<a class="btn btn-filter" data-bs-toggle="modal" data-bs-target="#add-units"><img src="images/plus1.svg" alt="img">
															</a>
														</div>
													</div>
												</div>
		...
		<!-- jQuery -->
        <script src="js/jquery-3.7.1.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="js/feather.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="js/jquery.slimscroll.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="js/jquery.dataTables.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>
		<script src="js/dataTables.bootstrap5.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

		<!-- Datetimepicker JS -->
		<script src="js/moment.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>
		<script src="js/bootstrap-datetimepicker.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="js/bootstrap.bundle.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

		<!-- Summernote JS -->
	    <script src="js/summernote-bs4.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="js/select2.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

		<!-- Sweetalert 2 -->
		<script src="js/sweetalert2.all.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>
		<script src="js/sweetalerts.min.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

		<!-- Custom JS -->
<script src="js/script.js" type="2665c5b5734dfc3094878e30-text/javascript"></script>

	
    <script src="js/rocket-loader.min.js" data-cf-settings="2665c5b5734dfc3094878e30-|49" defer=""></script>
</body></html>