<!DOCTYPE html><html lang="en">
	<?php include 'includes/head.php';?>
		<body>
			...
			<?php $page = 'purchase-order-report'; include './includes/sidebar.php'; ?>
			...
			<!-- jQuery -->
			<script src="js/jquery-3.7.1.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>

			<!-- Feather Icon JS -->
			<script src="js/feather.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>

			<!-- Slimscroll JS -->
			<script src="js/jquery.slimscroll.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>

			<!-- Datatable JS -->
			<script src="js/jquery.dataTables.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>
			<script src="js/dataTables.bootstrap5.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>
			
			<!-- Bootstrap Core JS -->
			<script src="js/bootstrap.bundle.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>

			<!-- Datetimepicker JS -->
			<script src="js/moment.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>
			<script src="js/bootstrap-datetimepicker.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>

			<!-- Select2 JS -->
			<script src="js/select2.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>
			...
			<!-- Sweetalert 2 -->
			<script src="js/sweetalert2.all.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>
			<script src="js/sweetalerts.min.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>

			<!-- Custom JS -->
<script src="js/script.js" type="ad8ffb3e8b304ebd9bf6df1e-text/javascript"></script>

	
		<script src="js/rocket-loader.min.js" data-cf-settings="ad8ffb3e8b304ebd9bf6df1e-|49" defer=""></script>
	</body></html>