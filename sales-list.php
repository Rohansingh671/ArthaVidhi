<!DOCTYPE html><html lang="en">
    ...
    <body>
											...
											<div class="sales-details-items d-flex">
												<div class="details-item">
													...
													<p>walk-in-customer<br>
														<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f780969b9cda9e99da94828483989a9285b7928f969a879b92d994989a">[email�protected]</a><br>
														123456780<br>
														N45 , Dhaka
													</p>
												</div>
												<div class="details-item">
													<h6>Company Info</h6>
													<p>DGT<br>
														<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ee8f8a838780ae8b968f839e828bc08d8183">[email�protected]</a><br>
														6315996770<br>
											...
											<div class="col-lg-12 col-sm-6 col-12">
												<div class="input-blocks">
													...
													<div class="input-groupicon select-code">
														<input type="text" placeholder="Please type product code and select">
														<div class="addonset">
															<img src="images/scanners.svg" alt="img">
														</div>
													</div>
												</div>
											</div>
		...
		<!-- jQuery -->
        <script data-cfasync="false" src="js/email-decode.min.js"></script><script src="js/jquery-3.7.1.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="js/feather.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="js/jquery.slimscroll.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="js/jquery.dataTables.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>
		<script src="js/dataTables.bootstrap5.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="js/bootstrap.bundle.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="js/select2.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

		<!-- Datetimepicker JS -->
		<script src="js/moment.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>
		<script src="js/bootstrap-datetimepicker.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

		<!-- Sweetalert 2 -->
		<script src="js/sweetalert2.all.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>
		<script src="js/sweetalerts.min.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

		<!-- Custom JS -->
<script src="js/script.js" type="dd44cb44084ec2184f6b2968-text/javascript"></script>

	
    <script src="js/rocket-loader.min.js" data-cf-settings="dd44cb44084ec2184f6b2968-|49" defer=""></script>
</body></html>