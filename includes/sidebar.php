		...
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				<li class="submenu-open">
					...
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class="subdrop <?php if ($page == 'adminDash' || $page == 'salesDash') {
																				echo 'active';
																			} ?>"><i data-feather="grid"></i><span>Dashboard</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="adminDash.php" class="<?php if ($page == 'adminDash') {
																		echo 'active';
																	} ?>">Admin Dashboard</a></li>
								<li><a href="sales-dashboard.php" class="<?php if ($page == 'salesDash') {
																				echo 'active';
				...
				<li class="submenu-open">
					...
					<ul>
						<li class="<?php if ($page == 'product-list') {
										echo 'active';
									} ?>"><a href="product-list.php"><i data-feather="box"></i><span>Job-cards</span></a></li>
						...
						<li hidden class="<?php if ($page == 'low-stocks') {
												echo 'active';
						...
						<li class="<?php if ($page == 'purpose-list') {
										echo 'active';
									} ?>">
							<a href="purpose-list.php"><i data-feather="clipboard"></i><span>Purpose List</span></a>
						</li>
						<li class="<?php if ($page == 'labour-code-details') {
										echo 'active';
									} ?>">
							<a href="labour-code-details.php"><i data-feather="users"></i><span>Labour Code List</span></a>
						</li>
						<li class="<?php if ($page == 'spare-parts') {
										echo 'active';
									} ?>">
							<a href="spare-parts.php"><i data-feather="settings"></i><span>Spare Parts List</span></a>
						</li>
						<li class="<?php if ($page == 'lubricants-list') {
										echo 'active';
									} ?>">
							<a href="lubricants-list.php"><i data-feather="droplet"></i><span>Lubricants List</span></a>
						</li>
						<li class="<?php if ($page == 'dentPaint-list') {
										echo 'active';
									} ?>">
						...
						<li hidden class="<?php if ($page == 'warranty') {
												echo 'active';
											} ?>"><a href="warranty.php"><i data-feather="bookmark"></i><span>Warranties</span></a></li>
						<li hidden class="<?php if ($page == 'barcode') {
												echo 'active';
											} ?>"><a href="barcode.php"><i data-feather="align-justify"></i><span>Print Barcode</span></a></li>
						<li hidden class="<?php if ($page == 'qrcode') {
												echo 'active';
											} ?>"><a href="qrcode.php"><i data-feather="maximize"></i><span>Print QR Code</span></a></li>
					</ul>
				</li>
				<li class="submenu-open">
					<h6 class="submenu-hdr">Stock</h6>
					<ul>
						<li class="<?php if ($page == 'manage-stocks') {
										echo 'active';
									} ?>"><a href="manage-stocks.php"><i data-feather="package"></i><span>Manage Stock</span></a></li>
						<li class="<?php if ($page == 'stock-adjustment') {
										echo 'active';
									} ?>"><a href="stock-adjustment.php"><i data-feather="clipboard"></i><span>Stock Adjustment</span></a></li>
						<li class="<?php if ($page == 'stock-transfer') {
										echo 'active';
									} ?>"><a href="stock-transfer.php"><i data-feather="truck"></i><span>Stock Transfer</span></a></li>
					</ul>
				</li>
				<li class="submenu-open">
					<h6 class="submenu-hdr">Sales</h6>
					<ul>
						<li class="<?php if ($page == 'sales-list') {
										echo 'active';
									} ?>"><a href="sales-list.php"><i data-feather="shopping-cart"></i><span>Sales</span></a></li>
						<li hidden class="<?php if ($page == 'invoice-report') {
												echo 'active';
											} ?>"><a href="invoice-report.php"><i data-feather="file-text"></i><span>Invoices</span></a></li>
						<li class="<?php if ($page == 'sales-returns') {
										echo 'active';
									} ?>"><a href="sales-returns.php"><i data-feather="copy"></i><span>Sales Return</span></a></li>
						<li class="<?php if ($page == 'quotation-list.php') {
										echo 'active';
									} ?>"><a href="quotation-list.php"><i data-feather="save"></i><span>Quotation</span></a></li>
						<li hidden class="<?php if ($page == 'pos') {
												echo 'active';
											} ?>"><a href="pos.php"><i data-feather="hard-drive"></i><span>POS</span></a></li>
				...
				<li class="submenu-open">
					...
					<ul>
						<li class="<?php if ($page == 'purchase-list') {
										echo 'active';
									} ?>"><a href="purchase-list.php"><i data-feather="shopping-bag"></i><span>Purchases</span></a></li>
						<li class="<?php if ($page == 'purchase-order-report') {
										echo 'active';
									} ?>"><a href="purchase-order-report.php"><i data-feather="file-minus"></i><span>Purchase Order</span></a></li>
						<li class="<?php if ($page == 'purchase-returns') {
										echo 'active';
									} ?>"><a href="purchase-returns.php"><i data-feather="refresh-cw"></i><span>Purchase Return</span></a></li>
				...
				<li class="submenu-open">
					...
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class="subdrop <?php if ($page == 'expense-list' || $page == 'expense-category') {
																				echo 'active';
																			} ?>"><i data-feather="file-text"></i><span>Expenses</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="expense-list.php" class="<?php if ($page == 'expense-list') {
																			echo 'active';
																		} ?>">Expenses</a></li>
								<li><a href="expense-category.php" class="<?php if ($page == 'expense-category') {
																				echo 'active';
				...
				<li class="submenu-open">
					...
					<ul>
						<li class="<?php if ($page == 'customers') {
										echo 'active';
									} ?>"><a href="customers.php"><i data-feather="user"></i><span>Customers</span></a></li>
						<li class="<?php if ($page == 'suppliers') {
										echo 'active';
									} ?>"><a href="suppliers.php"><i data-feather="users"></i><span>Suppliers</span></a></li>
						<li class="<?php if ($page == 'store-list') {
										echo 'active';
									} ?>"><a href="store-list.php"><i data-feather="home"></i><span>Stores</span></a></li>
						<li class="<?php if ($page == 'warehouse') {
										echo 'active';
									} ?>"><a href="warehouse.php"><i data-feather="archive"></i><span>Warehouses</span></a></li>
				...
				<li class="submenu-open">
					...
					<ul>
						<li class="<?php if ($page == 'employees-grid') {
										echo 'active';
									} ?>"><a href="employees-grid.php"><i data-feather="user"></i><span>Employees</span></a></li>
						<li class="<?php if ($page == 'department-grid') {
										echo 'active';
									} ?>"><a href="department-grid.php"><i data-feather="users"></i><span>Departments</span></a></li>
						<li class="<?php if ($page == 'designation') {
										echo 'active';
									} ?>"><a href="designation.php"><i data-feather="git-merge"></i><span>Designation</span></a></li>
						<li class="<?php if ($page == 'shift') {
										echo 'active';
									} ?>"><a href="shift.php"><i data-feather="shuffle"></i><span>Shifts</span></a></li>
						<li class="submenu">
							<a href="javascript:void(0);" class="subdrop <?php if ($page == 'payroll-list' || $page == 'payslip') {
																				echo 'active';
																			} ?>"><i data-feather="dollar-sign"></i><span>Payroll</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="payroll-list.php" class="<?php if ($page == 'payroll-list') {
																			echo 'active';
																		} ?>">Employee Salary</a></li>
								<li><a href="payslip.php" class="<?php if ($page == 'payslip') {
																		echo 'active';
																	} ?>">Payslip</a></li>
							</ul>
						</li>
				...
				<li class="submenu-open">
					...
					<ul>
						<li class="<?php if ($page == 'sales-report') {
										echo 'active';
									} ?>"><a href="sales-report.php"><i data-feather="bar-chart-2"></i><span>Sales Report</span></a></li>
						<li class="<?php if ($page == 'purchase-report') {
										echo 'active';
									} ?>"><a href="purchase-report.php"><i data-feather="pie-chart"></i><span>Purchase report</span></a></li>
						<li class="<?php if ($page == 'inventory-report') {
										echo 'active';
									} ?>"><a href="inventory-report.php"><i data-feather="inbox"></i><span>Inventory Report</span></a></li>
						<li class="<?php if ($page == 'invoice-report') {
										echo 'active';
									} ?>"><a href="invoice-report.php"><i data-feather="file"></i><span>Invoice Report</span></a></li>
						<li class="<?php if ($page == 'supplier-report') {
										echo 'active';
									} ?>"><a href="supplier-report.php"><i data-feather="user-check"></i><span>Supplier Report</span></a></li>
						<li class="<?php if ($page == 'customer-report') {
										echo 'active';
									} ?>"><a href="customer-report.php"><i data-feather="user"></i><span>Customer Report</span></a></li>
						<li class="<?php if ($page == 'expense-report') {
										echo 'active';
									} ?>"><a href="expense-report.php"><i data-feather="file"></i><span>Expense Report</span></a></li>
						<li class="<?php if ($page == 'income-report') {
										echo 'active';
									} ?>"><a href="income-report.php"><i data-feather="bar-chart"></i><span>Income Report</span></a></li>
						<li class="<?php if ($page == 'tax-reports') {
										echo 'active';
									} ?>"><a href="tax-reports.php"><i data-feather="database"></i><span>Tax Report</span></a></li>
						<li class="<?php if ($page == 'profit-and-loss') {
										echo 'active';
									} ?>"><a href="profit-and-loss.php"><i data-feather="pie-chart"></i><span>Profit & Loss</span></a></li>
					</ul>
				</li>
			</ul>
		</div>
