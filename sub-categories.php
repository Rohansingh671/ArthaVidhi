<!DOCTYPE html><html lang="en">
    ...
    <body>
        ...
        <div class="main-wrapper">
			...
			<?php $page = 'sub-categories'; include './includes/sidebar.php'; ?>
					...
					<div class="page-wrapper-new p-0">
						<div class="content">
							...
							<div class="modal-body custom-modal-body">
								<form action="sub-categories.php">
									<div class="mb-3">
		...
		<!-- jQuery -->
        <script src="js/jquery-3.7.1.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="js/feather.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="js/jquery.slimscroll.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="js/jquery.dataTables.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>
		<script src="js/dataTables.bootstrap5.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="js/bootstrap.bundle.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="js/select2.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>

		<!-- Sweetalert 2 -->
		<script src="js/sweetalert2.all.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>
		<script src="js/sweetalerts.min.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>

		<!-- Custom JS -->
<script src="js/script.js" type="a32a7bd187c0da44b1e3ebaa-text/javascript"></script>

	
    <script src="js/rocket-loader.min.js" data-cf-settings="a32a7bd187c0da44b1e3ebaa-|49" defer=""></script>
</body></html>