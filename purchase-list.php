...
<body>
	...
	<div class="main-wrapper">
		...
		<?php $page = 'purchase-list'; include './includes/sidebar.php'; ?>
										...
										<div class="col-lg-3 col-sm-6 col-12">
											<div class="input-blocks">
												...
												<div class="input-groupicon">
													...
													<div class="addonset">
														<img src="images/calendars.svg" alt="img">
													</div>
												</div>
											</div>
										</div>
												...
												<table class="table">
													...
													<tbody>
														<tr>
															...
															<td>1500</td>
															<td>
																<a class="delete-set"><img src="images/delete.svg" alt="svg"></a>
															</td>
														</tr>
													</tbody>
												</table>
	...
	<!-- jQuery -->
	<script src="js/jquery-3.7.1.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="js/feather.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="js/jquery.slimscroll.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Datatable JS -->
	<script src="js/jquery.dataTables.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>
	<script src="js/dataTables.bootstrap5.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="js/bootstrap.bundle.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Datetimepicker JS -->
	<script src="js/moment.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>
	<script src="js/bootstrap-datetimepicker.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Summernote JS -->
	<script src="js/summernote-bs4.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Select2 JS -->
	<script src="js/select2.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Sweetalert 2 -->
	<script src="js/sweetalert2.all.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>
	<script src="js/sweetalerts.min.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	<!-- Custom JS -->
<script src="js/script.js" type="2e46ba7b23e49e2038ce5e2b-text/javascript"></script>

	
<script src="js/rocket-loader.min.js" data-cf-settings="2e46ba7b23e49e2038ce5e2b-|49" defer=""></script>
