<!DOCTYPE html><html lang="en">
	...
	<body>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="text-center info text-center">
							...
							<p class="mb-0">Email: <a href="/cdn-cgi/l/email-protection#e18499808c918d84a1868c80888dcf828e8c"><span class="__cf_email__" data-cfemail="72170a131f021e1732151f131b1e5c111d1f">[email�protected]</span></a></p>
						</div>
		...
		<!-- jQuery -->
		<script data-cfasync="false" src="js/email-decode.min.js"></script><script src="js/jquery-3.7.1.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Feather Icon JS -->
		<script src="js/feather.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="js/jquery.slimscroll.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="js/jquery.dataTables.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>
		<script src="js/dataTables.bootstrap5.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="js/bootstrap.bundle.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Chart JS -->
		<script src="js/apexcharts.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>
		<script src="js/chart-data.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Daterangepikcer JS -->
		<script src="js/moment.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>
		<script src="js/daterangepicker.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Owl JS -->
		<script src="js/owl.carousel.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="js/select2.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

		<!-- Sweetalert 2 -->
		<script src="js/sweetalert2.all.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>
		<script src="js/sweetalerts.min.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>
		
		<!-- Custom JS -->
<script src="js/script.js" type="502566833b3b7cfcdf8e9fd5-text/javascript"></script>

	
	<script src="js/rocket-loader.min.js" data-cf-settings="502566833b3b7cfcdf8e9fd5-|49" defer=""></script>
</body></html>