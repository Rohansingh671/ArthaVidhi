		...
		<div class="page-wrapper">
			<div class="content">
				<div class="page-header">
					...
					<div class="page-btn">
						<a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-brand"><i data-feather="plus-circle" class="me-2"></i>Add New Lubricant</a>
					</div>
				</div>
				<!-- /product list -->
						...
						<div class="table-responsive">
							<table class="table  datanew">
								...
								<tbody>
									...
									require_once 'php/lubricantDataFromDatabase.php';
									foreach ($lubricantTypes as $lubricantType) {
									?>
										<tr>
											<td><a href="#" class="link-primary"><?php echo $lubricantType['lubricantID']; ?></a></td>
											<td><?php echo $lubricantType['lubricantType']; ?></td>
											<td><?php echo $lubricantType['lubricantCharge']; ?></td>
											<td><?php echo $lubricantType['status']; ?></td>
				...
				<div class="page-wrapper-new p-0">
					<div class="content">
						...
						<div class="modal-body custom-modal-body new-employee-field">
							<form action="php/lubricantsType.php" method="post">
								<?php
								require_once 'php/databaseConnection.php';

								$mysqli = db_connect();

								$result = $mysqli->query("SELECT lubricantID FROM lubricantDetails ORDER BY ID DESC LIMIT 1");
								$row = $result->fetch_row();

								if ($row == null) {
									$total_lub_id = 1; // Initialize $total_group_id here for the case where no rows are found
								} else {
									$lub_id = substr($row[0], 3); // Adjust substring length to skip "FGID"
									$total_lub_id = $lub_id + 1; // Increment the numeric part of the group ID
								}
								?>
								<div class="mb-3">
									<label class="form-label">Lubricant ID</label>
									<input type="text" name="lubricantID" class="form-control" value="LUB<?php echo $total_lub_id ?>" readonly>
								</div>
								<div class="mb-3">
									<label class="form-label">Lubricant Type</label>
									<input type="text" name="lubricantType" class="form-control">
								</div>
								<div class="mb-3">
									<label class="form-label">Lubricant Charge</label>
									<input type="text" name="lubricantCharge" class="form-control">
								</div>
								<div class="mb-0">
									<label class="form-label">Status</label>
									<select class="select" name="lubStatus">
								...
								<div class="modal-footer-btn">
									...
									<button type="submit" class="btn btn-submit">Save Lubricant</button>
								</div>
							</form>
						</div>
					</div>
