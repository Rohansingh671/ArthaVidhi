<!DOCTYPE html><html lang="en" data-layout-mode="light_mode">
...
<body>
	...
	<div class="main-wrapper">
		...
		<?php $page = 'adminDash';include './includes/sidebar.php'; ?>
	...
	<!-- jQuery -->
	<script src="js/jquery-3.7.1.min.js" type="1041c65cfbdd648860d317db-text/javascript"></script>

	<!-- Feather Icon JS -->
	<script src="js/feather.min.js" type="1041c65cfbdd648860d317db-text/javascript"></script>

	<!-- Slimscroll JS -->
	<script src="js/jquery.slimscroll.min.js" type="1041c65cfbdd648860d317db-text/javascript"></script>

	<!-- Bootstrap Core JS -->
	<script src="js/bootstrap.bundle.min.js" type="1041c65cfbdd648860d317db-text/javascript"></script>

	<!-- Chart JS -->
	<script src="js/apexcharts.min.js" type="1041c65cfbdd648860d317db-text/javascript"></script>
	<script src="js/chart-data.js" type="1041c65cfbdd648860d317db-text/javascript"></script>

	<!-- Sweetalert 2 -->
	<script src="js/sweetalert2.all.min.js" type="1041c65cfbdd648860d317db-text/javascript"></script>
	<script src="js/sweetalerts.min.js" type="1041c65cfbdd648860d317db-text/javascript"></script>

	<!-- Custom JS -->
	
		<script src="js/script.js" type="1041c65cfbdd648860d317db-text/javascript"></script>

	
<script src="js/rocket-loader.min.js" data-cf-settings="1041c65cfbdd648860d317db-|49" defer=""></script>
