<!DOCTYPE html><html lang="en">
	<?php include 'includes/head.php';?>
		<body>
			...
			<?php $page = 'sales-return'; include './includes/sidebar.php'; ?>
			...
			<!-- jQuery -->
			<script src="js/jquery-3.7.1.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>

			<!-- Feather Icon JS -->
			<script src="js/feather.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>

			<!-- Slimscroll JS -->
			<script src="js/jquery.slimscroll.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>

			<!-- Datatable JS -->
			<script src="js/jquery.dataTables.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>
			<script src="js/dataTables.bootstrap5.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>
			
			<!-- Bootstrap Core JS -->
			<script src="js/bootstrap.bundle.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>

			<!-- Datetimepicker JS -->
			<script src="js/moment.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>
			<script src="js/bootstrap-datetimepicker.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>

			<!-- Select2 JS -->
			<script src="js/select2.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>

			<!-- Sweetalert 2 -->
			<script src="js/sweetalert2.all.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>
			<script src="js/sweetalerts.min.js" type="7fd449eb47f607827719907f-text/javascript"></script>

			<!-- Custom JS -->
<script src="js/script.js" type="7fd449eb47f607827719907f-text/javascript"></script>

	
		<script src="js/rocket-loader.min.js" data-cf-settings="7fd449eb47f607827719907f-|49" defer=""></script>
	</body></html>