<!DOCTYPE html><html lang="en">
	...
	<body>
        ...
        <div class="main-wrapper">
			...
			<?php $page = 'tax-reports'; include './includes/sidebar.php'; ?>
		...
		<!-- jQuery -->
        <script src="assets/js/jquery-3.7.1.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

        <!-- Feather Icon JS -->
		<script src="assets/js/feather.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

		<!-- Slimscroll JS -->
		<script src="assets/js/jquery.slimscroll.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

		<!-- Datatable JS -->
		<script src="assets/js/jquery.dataTables.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>
		<script src="assets/js/dataTables.bootstrap5.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
        <script src="assets/js/bootstrap.bundle.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

		<!-- Datetimepicker JS -->
		<script src="assets/js/moment.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>
		<script src="assets/js/bootstrap-datetimepicker.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

		<!-- Daterangepikcer JS -->
		<script src="assets/js/moment.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>
		<script src="assets/plugins/daterangepicker/daterangepicker.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

		<!-- Select2 JS -->
		<script src="assets/plugins/select2/js/select2.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

		<!-- Sweetalert 2 -->
		<script src="assets/plugins/sweetalert/sweetalert2.all.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>
		<script src="assets/plugins/sweetalert/sweetalerts.min.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

		<!-- Custom JS -->
<script src="assets/js/script.js" type="faf08f8a9cb694378d3078a9-text/javascript"></script>

	
    <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="faf08f8a9cb694378d3078a9-|49" defer=""></script>
</body></html>